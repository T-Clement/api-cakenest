...
Route::group(['middleware' => ['auth:sanctum']], function () {
    Route::get("/test", function() {return ["test" => "test"]; });
    ...
    Route::group(['middleware' => isAdmin::class], function() {
        Route::delete('/cupcake/{id}', [CupcakeController::class, 'destroy'])->name('cupcake.delete'); // TO TEST -> admin
        Route::post('/cupcake/create', [CupcakeController::class, "store"])->name('cupcake.store'); // TO TEST -> admin
